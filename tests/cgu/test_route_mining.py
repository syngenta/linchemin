...
from linchemin.cgu.route_mining import old_route_miner, RouteFinder
...
def test_route_extractor():
    ...
    with unittest.TestCase().assertLogs('linchemin.cgu.route_mining', level='WARNING'):
        new_routes3 = old_route_miner(new_routes2, ['CCO.OC(=O)C1=NC=CC(Cl)=C1>>CCOC(=O)C1=NC=CC(Cl)=C1'])
